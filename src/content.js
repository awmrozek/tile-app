const content = {
    biomed: {
        ...
        text: `Thesis in biomedical engineering started an interest for biology and chemistry. I can solve problems with connection to biochemistry, medicine, life science and even interactions between drugs.`
    },
    systems: {
...
We solve problems in systematic and structured way, which guarantees reliable time estimates and solutions. We like to understand how the solution works in its environment. Teamwork makes the dream work.`
    ...
    ai: {
        title: "AI",
        text: `
Following latest trends, application of AI are one of the services I can offer for your institution, including incorporation of language models like chatbots to your systems or more solutions utilizing natural language processing.

Our involvement with AI includes, but does not limit to:
 * Development and maintenance of hardware for running and training language models
 * Training large language models with new data to achieve infallable results
 * Development of software and hardware utilizing AI
`
    },
    culture: {
